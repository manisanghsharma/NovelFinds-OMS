...
const AddOrderModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-lg bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg m-5 shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {availableBooks.map(book => (
                        ...
                        >
                          ...
                          <td className="px-4 py-2 text-sm text-gray-500">₹{book.purchaseCost}</td>
                          <td className="px-4 py-2 text-sm text-gray-500">{book.weight} kg</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
