...
const CustomerDetailsModal = ({ isOpen, onClose, customer }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white m-5 rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">{customer.socialHandle}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                {customer.otherPhone && (
                  <div className="flex items-start space-x-2">
                    <Phone size={18} className="text-indigo-600 mt-0.5" />
                    <div>
                      <div className="text-sm text-gray-500">Other Phone:</div>
                      <div className="font-medium">{customer.otherPhone}</div>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-gray-800 border-b pb-2">Address</h3>
              <div className="flex items-start space-x-2">
          ...
          {/* Customer Orders */}
          <div>
            <h3 className="text-lg font-medium text-gray-800 border-b pb-2 mb-4">Order History</h3>
